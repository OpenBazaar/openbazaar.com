	...
	<div id="Purchasing-Modal" class="Purchasing-Modal">
		...
		<div style="margin-top:30px">
			...
			<div style="display: table-row; vertical-align: middle;">
				<div class="modal-button" onclick="location.href='ob://<?=$peerID?>/store';">Open user profile in OpenBazaar</div>
			...
			<div style="display: table-row; vertical-align: middle;">
				<div class="modal-button copy-btn" data-type="attribute" data-attr-name="data-clipboard-text" data-model="obLink" style="width:62px;height:38px;">Copy URL</div>
