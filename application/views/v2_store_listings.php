    ...
    <div class="v2-store-bodyContainer">
        ...
        <div class="v2-store-listingsContainer">
            ...
            <div class="v2-store-listingsBody">
                ...
                ?>
                        <div class="v2-listingBox" rating="<?=$listing->averageRating?>" freeShipping="<?=implode(",", $listing->freeShipping)?>" category="<?=($listing->categories) ? implode(",", $listing->categories): "";?>" onclick="gotoListing('<?=$profile->peerID?>', '<?=$listing->slug?>');">
