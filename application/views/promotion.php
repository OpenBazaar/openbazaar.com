<div class="Rectangle-10 clearfix">
  <div class="Page-Sub-Content">
    <div class="Listing-Box" style="padding-bottom: 0; text-align: center;">
      ...
      <div style="text-align: center; margin-bottom: 5px; color: #777">Join the OpenBazaar community — Get $10 towards your first purchase on OpenBazaar.</div>

      <!-- social sharing stuff -->
      <div style="margin-bottom: 5px">
        <a href="https://twitter.com/intent/tweet?text=Join the @OpenBazaar community — Get $10 towards your first purchase on %23OpenBazaar. 🤑 %23bitcoin %23btc" target="_blank" title="Share on Twitter"><img src="<?=asset_url()?>img/icon-twitter.png" height=12.5 style="margin-right: 5px" /></a>
        ...
        <a href="http://pinterest.com/pin/create/button/?url=<?=base_url()?>/bitcoin-promotion&media=https://www.openbazaar.org/wp-content/uploads/2018/04/openbazaar-2.0-teaser.jpg&description=Join the OpenBazaar community — Get $10 towards your first purchase on OpenBazaar. 🤑" target="_blank"  title="Share on Pinterest"><img src="<?=asset_url()?>img/icon-pinterest.png" height=12.5 target="_blank"/></a>
      </div>
    ...
    <div class="Listing-Box" style="margin-top: 15px">
        ...
        <div style="margin-bottom: 5px">
          <div>
          <a href="https://twitter.com/intent/tweet?text=Join the @OpenBazaar community — Get $10 towards your first purchase on %23OpenBazaar. 🤑 %23bitcoin %23btc" target="_blank" title="Share $10 on Twitter"><div class="Share-Button"><img src="<?=asset_url()?>img/icon-twitter.png" height=12.5 /> Share $10 on Twitter</div></a>
          ...
          <a href="http://pinterest.com/pin/create/button/?url=<?=base_url()?>/bitcoin-promotion&media=https://www.openbazaar.org/wp-content/uploads/2018/04/openbazaar-2.0-teaser.jpg&description=Join the OpenBazaar community — Get $10 towards your first purchase on OpenBazaar. 🤑" target="_blank"  title="Share $10 on Pinterest"><div class="Share-Button"><img src="<?=asset_url()?>img/icon-pinterest.png" height=12.5 target="_blank"/> Share $10 on Pinterest</div></a>
          </div>
          <br />
          <br />
        </div>
