  ...
  <div class="Page-Sub-Content" style="background: url(http://localhost:8080/assets/img/openbazaar-background.png)">
    <div class="Listing-Box" style="padding-bottom: 0; text-align: center;">
      ...
      <div style="margin-bottom: 5px">
        <a href="https://twitter.com/intent/tweet?text=🤑 Get $10 in Bitcoin when you try @OpenBazaar %23bitcoin %23btc" target="_blank" title="Share on Twitter"><img src="<?=asset_url()?>img/icon-twitter.png" height=12.5 style="margin-right: 5px" /></a>
        ...
        <a href="http://pinterest.com/pin/create/button/?url=<?=base_url()?>/bitcoin-promotion&media=https://www.openbazaar.org/wp-content/uploads/2018/04/openbazaar-2.0-teaser.jpg&description=Get $10 in Bitcoin when you try OpenBazaar" target="_blank"  title="Share on Pinterest"><img src="<?=asset_url()?>img/icon-pinterest.png" height=12.5 target="_blank"/></a>
      </div>
    ...
    <div class="Listing-Box" style="margin-top: 15px">
        <b>Want more?</b>
        <div style="margin: 10px 0">Learn about all the latest OpenBazaar features & updates by joining our <a href="https://openbazaar.org/newsletter" title="OpenBazaar Newsletter" target="_blank">newsletter</a>.</div>
        <div>Learn more about the project at <a href="https://openbazaar.org/" title="OpenBazaar" target="_blank">OpenBazaar.org</a></div>
      </div>
    </div>
  </div>
</div>