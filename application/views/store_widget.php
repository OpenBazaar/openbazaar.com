...
<div class="Rectangle-10 clearfix">
	...
	<div class="Page-Sub-Content clearfix Page-Sub-Content-Mobile">		
		<div class="Listing-Box" style="padding-bottom: 0; text-align: center;padding-left:0;padding-right:0;height:100%;">
            ...
            <form action="javascript:void();" onsubmit="location.href='/store/'+encodeURIComponent(document.getElementById('frm-search-input').value);">
              ...
              <div class="Btn-Copy-Code" onclick="alert('test');"><div style="flex:1;">Copy Code</div></div>
              ...
              <div style="text-align:left;padding:31px;">
                ...
                copy the code above and paste it within the body tag of your website.</p>
              </div>
